...
//our file is properties and java conn't read it therefore there is there Properties class and we use this like below
		 ...
		 prop.getProperty("url"); //we read the url from config.properties and to make same we make globle variable
